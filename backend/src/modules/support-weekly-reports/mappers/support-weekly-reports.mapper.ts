...
import { SupportWeeklyReportEntity } from '../entities/support-weekly-report.entity';
import { SupportWeeklyReportWithRelations } from '../repositories/support-weekly-reports.repository';
...
@Injectable()
export class SupportWeeklyReportsMapper {
  toEntity(report: SupportWeeklyReportWithRelations): SupportWeeklyReportEntity {
    return {
      id: report.id,
  ...
  toResponse(entity: SupportWeeklyReportEntity): SupportWeeklyReportResponseDto {
    return { ...entity };
  }
}
